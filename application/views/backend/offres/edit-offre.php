                    ...
                    <div class="col-lg-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <strong>Modifier l'offre</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="<?= base_url() ?>offre/editoffre/<?= $offre->id; ?>" method="post" class="form-horizontal">
                                    <div class="row">
                                        <div class="form-group col col-md-4">
                                            ...
                                            <select name="partenaire_id" id="partenaire_id" onchange="get_services_by_partenaire(this.value)"  class="form-control">
                                                ...
                                                <?php  $service = get_name_of_service_id($offre->service_id); ?>
                                                <?php foreach ($partenaires as $partenaire) { ?>
                                                    <option <?php if ($partenaire->id == $service->partenaire_id) echo 'selected'; ?>  value="<?= $partenaire->id ?>"><?= $partenaire->nom ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col col-md-4">
                                            ...
                                            <select name="service_id" id="service_id" onchange="get_chambres_by_service(this.value)"
                                                    class="form-control">
                                                <option value="<?= $offre->service_id ?>"><?php echo get_name_categorie_by_id($service->categorie_id). ":" . get_name_souscategorie_by_id($service->sous_categorie_id); ?></option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row ">
                                        <div class="form-group col col-md-3">
                                            <label for="text-input" class=" form-control-label">Nouv. Prix/Dh <span
                                                        class="required">*</span></label>
                                            <input type="number" value="<?= $offre->new_prix ?>" autocomplete="off" min="1" id="new_prix" required name="new_prix"
                                        ...
                                        <div class="form-group col col-md-3">
                                            <label for="text-input" class=" form-control-label">Pourcentage/% <span
                                                        class="required">*</span></label>
                                            <input type="number" value="<?= $offre->pourcentage ?>" autocomplete="off" min="1" id="pourcentage" required name="pourcentage"
