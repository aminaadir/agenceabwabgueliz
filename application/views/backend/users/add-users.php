                    ...
                    <div class="col-lg-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <strong>Ajouter un nouveau Admin</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="<?= base_url()?>client/addadmin" method="post" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-7">
                                            <input type="text" id="tel1" required name="telephone" placeholder="Exemple : 0524xxxxxx..." class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
