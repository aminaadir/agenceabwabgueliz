                    ...
                    <div class="col-lg-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <strong>Ajouter une nouvelle service</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="<?= base_url() ?>service/add" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="row">
                                    ...
                                    <div class="row ">
                                        <div class="form-group col col-md-4">
                                            <label for="text-input" class=" form-control-label">Prix en Dh <span
                                                        class="required">*</span></label>
                                            <input type="number"  autocomplete="off" onkeyup="calculprix()" min="1" id="prixini" required name="initial_prix"
                                        ...
                                        <div class="form-group col col-md-4" id="pluss_news1">
                                            <label for="text-input" class=" form-control-label">% <span
                                                        class="required">*</span></label>
                                            <input type="number"  autocomplete="off" onkeyup="calculprix(this.value)" onchange="calculprix()" value="0" min="0" min="100" id="percent" required name="percent"
                                        ...
                                        <div class="form-group col col-md-4" id="pluss_news2">
                                            ...
                                            <input type="number"  autocomplete="off" readonly="true" id="prix" required name="prix"
                                    ...
                                    <div class="row ">
                                        <div class="form-group col col-md-4">
                                            <label for="text-input" class=" form-control-label">Lieu Depart<span
                                                        class="required">*</span></label>
                                            <input type="text"  autocomplete="off" id="lieu" required name="lieu"
                                                   placeholder="Tappez le lieu de depart..." class="form-control">
                                        </div>
                                        <div class="form-group col col-md-4">
                                            <label for="text-input" class=" form-control-label">Lieu d'arrivee<span
                                                        class="required">*</span></label>
                                            <input type="text"  autocomplete="off" id="lieu" required name="lieu2"
                                                   placeholder="Tappez le lieu d'arrivee..." class="form-control">
                                        </div>
                                        <div class="form-group col col-md-4">
                                            ...
                                            <input type="text"  autocomplete="off" id="disponibilite" required name="disponibilite"
                                                   placeholder="(Format : AAAA-MM-JJ / AAAA-MM-JJ)" class="form-control">
                                        </div>
                                        <!-- <div class="form-group col col-md-4">
                                            ...
                                            <input type="number"  autocomplete="off" id="Nuits" required name="Nuits"
                                                   placeholder="Tappez Disponibilité du service..." class="form-control">
                                        </div> -->
                                        <div class="form-group col col-md-4">
                                        ...
                                        <div class="form-group col col-md-4">
                                            <label for="text-input" class=" form-control-label">Titre <span
                                                        class="required">*</span></label>
                                            <input type="text"  autocomplete="off" id="titre" required name="titre"
                                                   placeholder="Tappez le titre du service..." class="form-control">
                                        </div>
                                        <div class="form-group col col-md-4">
                                            <label for="text-input" class=" form-control-label">Nom_hotel à Makka <span
                                                        class="required">*</span></label>
                                            <input type="text"  autocomplete="off" id="titre_hotel" required name="titre_hotel"
                                                   placeholder="Tappez le nom de hotel..." class="form-control">
                                        </div>
                                        <div class="form-group col col-md-4">
                                            ...
                                            <input type="text"  autocomplete="off" id="titre_hotel_Medina" required name="titre_hotel_Medina"
                                                   placeholder="Tappez le nom de hotel à medina..." class="form-control">
                                        </div>
                                        ...
                                        <div style="display:none;"class="form-group col col-md-4">
                                            <label for="text-input" class=" form-control-label">Maps Latitude <span
                                                        class="required">*</span></label>
                                            <input type="text"  autocomplete="off" id="maps_x" required name="maps_x"
                                                   value="34.323233" class="form-control">
                                        </div>
                                        <div  style="display:none;"class="form-group col col-md-4">
                                            <label for="text-input" class=" form-control-label">Maps Longitude <span
                                                        class="required">*</span></label>
                                            <input type="text"  autocomplete="off" id="maps_y" required name="maps_y"
                                                   value="-84.323233" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col col-md-12">
                                            <label for="text-input" class=" form-control-label">Grand description<span
                                                        class="required">*</span></label>
                                            <textarea class="summernote" id="grand_desc" name="grand_desc">
                                    ...
                                    <div class="row">
                                        <div class="form-group col col-md-12">
                                            ...
                                            <textarea class="summernote" id="conditions" name="conditions">
